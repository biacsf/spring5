...
import com.example.aprendendo.model.Difficulty;
import com.example.aprendendo.model.Ingredient;
import com.example.aprendendo.model.Notes;
import com.example.aprendendo.model.Recipe;
import com.example.aprendendo.model.UnitOfMeasure;
import com.example.aprendendo.repository.CategoryDAO;
import com.example.aprendendo.repository.RecipeDAO;
import com.example.aprendendo.repository.UnityOfMeasureDAO;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
	...
	private final UnityOfMeasureDAO unityOfMeasureDAO;

	public RecipeBootstrap(CategoryDAO categoryDAO, RecipeDAO recipeDAO, UnityOfMeasureDAO unityOfMeasureDAO) {
		this.categoryDAO = categoryDAO;
		this.recipeDAO = recipeDAO;
		this.unityOfMeasureDAO = unityOfMeasureDAO;
	}

	@Override
	public void onApplicationEvent(ContextRefreshedEvent event) {
		recipeDAO.saveAll(getRecipes());
	}
	...
	private List<Recipe> getRecipes() {
		...
		// get UOMs
		Optional<UnitOfMeasure> eachUomOptional = unityOfMeasureDAO.findByDescription("Each");

		if (!eachUomOptional.isPresent()) {
			throw new RuntimeException("Expected UOM Not Found");
		}

		Optional<UnitOfMeasure> tableSpoonUomOptional = unityOfMeasureDAO.findByDescription("Tablespoon");

		if (!tableSpoonUomOptional.isPresent()) {
			throw new RuntimeException("Expected UOM Not Found");
		}

		Optional<UnitOfMeasure> teaSpoonUomOptional = unityOfMeasureDAO.findByDescription("Teaspoon");

		if (!teaSpoonUomOptional.isPresent()) {
			throw new RuntimeException("Expected UOM Not Found");
		}

		Optional<UnitOfMeasure> dashUomOptional = unityOfMeasureDAO.findByDescription("Dash");

		if (!dashUomOptional.isPresent()) {
			throw new RuntimeException("Expected UOM Not Found");
		}

		Optional<UnitOfMeasure> pintUomOptional = unityOfMeasureDAO.findByDescription("Pint");

		if (!pintUomOptional.isPresent()) {
			throw new RuntimeException("Expected UOM Not Found");
		}

		Optional<UnitOfMeasure> cupsUomOptional = unityOfMeasureDAO.findByDescription("Cup");
		...
		// get Categories
		Optional<Category> americanCategoryOptional = categoryDAO.findByDescription("American");

		if (!americanCategoryOptional.isPresent()) {
			throw new RuntimeException("Expected Category Not Found");
		}

		Optional<Category> mexicanCategoryOptional = categoryDAO.findByDescription("Mexican");
